...
revoke all on function public.delete_logs_for_studio(bigint[], uuid) from public;
grant execute on function public.delete_logs_for_studio(bigint[], uuid) to authenticated;
